...
import { DummyTeacherSM } from "../../service/app/v1/dummy-teacher-s-m";

export class DummyTeacherViewModel extends BaseViewModel {
  override PageTitle: string = "Dummy Teacher";
  AddEditModalTitle: string = "";
  dummyTeachers: DummyTeacherSM[] = [];
  singleDummyTeacher!: DummyTeacherSM;
  firstName!: string;
  lastName!: string;
  emailAddress!: string;
  override controlsInformation: { [key: string]: InputControlInformation } = {
    firstName: {
      ...
      validations: [
        ...
        {
          type: "maxlength",
          message: "First Name Code must be less than 6 characters.",
        },
      ],
    },
    lastName: {
      ...
      validations: [
        ...
        {
          type: "maxlength",
          message: "Last Name Code must be less than 6 characters.",
        },
      ],
    },
    emailAddress: {
      ...
      validations: [
        ...
        {
          type: "maxlength",
          message: "Email must be less than 25 characters.",
        },
      ],
    },
